  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: (widget.height == null)
          ? 13.0 * SizeConfig.blockHeight
          : widget.height,
      child: Container(
        margin: EdgeInsets.symmetric(vertical: 2.0 * SizeConfig.blockHeight),
        padding: EdgeInsets.symmetric(horizontal: 4.0 * SizeConfig.blockHeight),
